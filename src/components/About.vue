...
<template>
    <div id="about" class="px-4 animate-fade-in delay-2">
        ...
        <a href="https://docs.google.com/document/d/1D9YIwWWVdWsGeWcl1L7n1oT225iZF7APGPB2yBC3F0E/edit?usp=sharing" target="_blank" class="text-accent md:hidden mt-10 cursor-pointer flex items-center gap-2">
